...
<head>
  ...
  <script src="https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=false&key=AIzaSyBSXjx1KsqqRBhBvhHFTBXYFMxweFuw_DQ&signed_in=true&libraries=places,visualization"></script>
</head>
